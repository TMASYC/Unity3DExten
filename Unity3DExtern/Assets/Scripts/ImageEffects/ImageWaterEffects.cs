...
[ExecuteInEditMode]
[AddComponentMenu("shaderTry/ScreenWaterDropEffect")]
public class ImageWaterEffects : MonoBehaviour 
{
    //-------------------变量声明部分-------------------
    #region Variables
    ...
    void Start()
    {
        ...
        //载入素材图
        ScreenWaterDropTex = Resources.Load("OIP-C") as Texture2D;

        //找到当前的Shader文件
        CurShader = Shader.Find("shaderTry/ScreenWaterDropEffect");
